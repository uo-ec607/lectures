...
- Cheatsheat: https://github.com/rstudio/cheatsheets/raw/master/rmarkdown-2.0.pdf (auto download)
...
- FWIW, my lecture slides and notes are all written in R Markdown too. (E.g. This slide deck is built the [xaringan package](https://github.com/yihui/xaringan/wiki) with the metroplis theme.)
...
6. Choose the project location ("Create project as subdirectory of:") and click **Create Project**.
  - You may be challenged for your GitHub credential. Learn how to cache these for future use [here](https://happygitwithr.com/credential-caching.html).
...
Now that you've cloned your first repo, it's time to learn the four main Git operations.
...
- *Pulled* from the GitHub repo just in case anyone else made changes (not expected here, but good practice).
- *Pushed* our changes to the GitHub repo.

</br>

**NB.** Always pull from the upstream repo before you push any changes. Seriously, do this even on solo projects. Making it a habit will save you headaches down the road.

---

# Aside: Why this workflow?
...
- Potentially more appropriate for projects that aren't primarily based in R. (Although, no real harm from using RStudio Projects to clone a non-R repo.)
