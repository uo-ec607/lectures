...
- **Read:** "[Democratic databases: science on GitHub](https://www.nature.com/news/democratic-databases-science-on-github-1.20719)" (*Nature*).
...
I also want to bookmark this as a general point that we'll revisit many times during the course: 
...
6. Check that your new repo is located where you want it to be ("Create project as subdirectory of:") and click "OK".
...
Practice by creating your own repo on GitHub and cloning it via an RStudio Project.
- Call it "testing" (or whatever you like).
