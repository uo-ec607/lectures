...
```{r cars_basefig, fig.height=4, dev="svg"}
...
```{r gapm_plot, fig.height=4, dev="svg"}
library(ggplot2)
...
```{r aesthetics2, fig.height=4, dev='svg'}
...
```{r aesthetics3, fig.height=4, dev='svg'}
p + 
...
```{r layers2, fig.height=4, dev='svg'}
p2
```
