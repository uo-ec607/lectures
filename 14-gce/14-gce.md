...
```bash
GCE_AUTH_FILE="/fullpath-to-your-service-key/filename.json" ## Use full path
GCE_DEFAULT_PROJECT_ID="your-project-id-here" ## Probably some random string like violet-ghost123
