...
Here's the adapted gameplan:
- First, create the new file by grapping the header (i.e. top line) of any of the input files and redirecting it. No need for `touch` this time.
...
I know we covered a _lot_ of ground today. I hope that I've given you a sense of how Bash works and how useful it can be.
...
- Environment variables, SSH, memory management (e.g. [top](https://ss64.com/bash/top.html) and [htop](https://hisham.hm/htop/)), etc.
