...
The "shell", "terminal", "tty", "command prompt"... these are basically<sup>1</sup> just different names for the same thing.
...
.footnote[
<sup>1</sup> [Truth be told](https://unix.stackexchange.com/questions/4126/what-is-the-exact-difference-between-a-terminal-a-shell-a-tty-and-a-con), there are some subtle and sometimes important differences, as well as some pretty interesting history behind them. But we can abstract from these differences here.
]

--

FWIW, I primarily use the Z shell (zsh) in my day-to-day work, which is why it might look [somewhat different](https://ohmyz.sh/) to yours during live coding sessions. 
...
- Why doesn't `$ cd My Documents` work? (Try typing it in.)

--

**Answer:** Bash syntax is unapologetically strict about spaces and ordering. It thinks that "My" and "Documents" are separate arguments.
...
Let's think a bit more about the permissions that we saw attached to the previous file.


---

# The super user: root, sudo, etc.
...
# The super user: root, sudo, etc. (cont.)
...
**Answer:** Invoke temporary super user status with `sudo`.
--
