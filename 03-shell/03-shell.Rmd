...
<i>
Personal aside: One of the (many) nice things about being a Linux user is that it demystifies the shell. You end up using the shell for various day-to-day operations and so inevitably become very comfortable using it. Maybe try a Linux distro yourself? ;-)
- I recommend [Endeavour OS](https://endeavouros.com/), although [Ubuntu](https://ubuntu.com/) and [Elementary](https://elementary.io/) are good places to start too.
</i>
