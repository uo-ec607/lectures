...
```{r cpt_cont, include=FALSE, eval=FALSE}
cpt_cont = 
  jsonlite::fromJSON("https://citymaps.capetown.gov.za/agsext1/rest/services/Theme_Based/Open_Data_Service/MapServer/15/query?where=1%3D1&outFields=*&outSR=4326&f=json") 

```

```{r cpt_cont_sf, include=FALSE, eval=FALSE}
library(geojsonio)
cpt_cont = geojson_read("https://opendata.arcgis.com/datasets/d179f9e0faf145a2957617da1b231892_15.geojson")

url <- "https://opendata.arcgis.com/datasets/d179f9e0faf145a2957617da1b231892_15.geojson"
geojson_read(url)
geojson_read(url, parse = TRUE)

cpt_cont_sf = st_as_sf(cpt_cont)
cpt_cont_sf
```
