...
```{r future_nested_cluster_noeval, dependson=vms_nested, dependson=chunk_func, eval=FALSE}
...
```{r future_nested_cluster, dependson=vms_nested, dependson=chunk_func, message=FALSE, echo=FALSE}
...
```{r future_nested_cluster_DT_noeval, dependson=vms_nested, dependson=chunk_func, eval=FALSE}
...
```{r future_nested_cluster_DT, dependson=vms_nested, dependson=chunk_func, message=FALSE, echo=FALSE}
## NOTE: This chunk simply repeats the previous ones, but actually *evaluates*
## them. Why do this? Because keeping the plan() and the future_lapply() calls
## together avoids problems with Rmd caching missteps. Obviously we'll set 
## echo=FALSE to avoid printing things out twice in the knitted document.
